...
5. **Synthesize CAD program or parametric structure** - CadQuery, FreeCAD Python, OpenSCAD, STEP-oriented structured representation
...
#### Hybrid path
This is the best long-term plan: start with a harness, collect traces/corrections/CAD execution logs/failure cases, fine-tune only once you know what the harness consistently fails on.
...
- Public benchmark data for Opus 4.7 on CAD-specific tasks is still limited.
